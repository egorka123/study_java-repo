...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
       ...
       {
           if (apartaments.get(i) instanceof Apt1Room)  Apt1Room.clean1Room();
           if (apartaments.get(i) instanceof Apt2Room) Apt2Room.clean2Rooms();
           if (apartaments.get(i) instanceof Apt3Room) Apt3Room.clean3Rooms();
